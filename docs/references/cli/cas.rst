...
.. note::
    ...
    This utility is part of Cahute; see :ref:`install-guide` for more
    information on how to install it.

.. warning::

    This utility is experimental; enabling :ref:`CMAKE_CLI_EXPERIMENTAL
    <cmake-ref-setting-cahute-cli-experimental>` at build time is required to
...
Default options are defined in the casrc file; see
:ref:`file-format-topic-casrc` for more information.
...
``-i=[<format>,]<args>``
    *Long forms:* ``--input=[<format>,]<args>``,
    ...
    See :ref:`file-format-topic-casrc-component-format` and
    :ref:`file-format-topic-casrc-available-settings` for more information.
...
``-m=<model>``
    *Long form:* ``--model=<model>``
    ...
    See :ref:`file-format-topic-casrc-component-format` and
    :ref:`file-format-topic-casrc-model-setting` for more information.
