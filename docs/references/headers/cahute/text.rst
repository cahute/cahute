...
.. c:macro:: CAHUTE_TEXT_ENCODING_LEGACY_8
    ...
    Constant representing the :ref:`format-topic-text-encoding-fc8` with
    the legacy character table.

.. c:macro:: CAHUTE_TEXT_ENCODING_LEGACY_16_HOST

    Constant representing the :ref:`format-topic-text-encoding-fc16` with
...
.. c:macro:: CAHUTE_TEXT_ENCODING_CAT
    ...
    Constant representing the :ref:`format-topic-text-encoding-cat`.

.. c:macro:: CAHUTE_TEXT_ENCODING_CTF

    Constant representing the :ref:`format-topic-text-encoding-ctf`.

.. c:macro:: CAHUTE_TEXT_ENCODING_UTF32_HOST

    Constant representing the :ref:`format-topic-text-encoding-utf32`, with
    host endianness.
...
.. c:macro:: CAHUTE_TEXT_ENCODING_UTF8
    ...
    Constant representing the :ref:`format-topic-text-encoding-utf8`.
...
.. c:function:: int cahute_convert_text(cahute_context *context, \
    ...
    * In case of :c:macro:`CAHUTE_ERROR_INVALID` or
    ...
    :ref:`developer-guide-convert-text`.
