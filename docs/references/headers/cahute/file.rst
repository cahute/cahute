...
.. _header-ref-cahute-file-type-macros:

``CAHUTE_FILE_TYPE_*`` are constants representing the type of an opened file.

.. c:macro:: CAHUTE_FILE_TYPE_ADDIN_CG

    fx-CG add-in; see :ref:`file-format-topic-g3a` for more information.

.. c:macro:: CAHUTE_FILE_TYPE_ADDIN_FX

    fx add-in; see :ref:`file-format-topic-g1a` for more information.

.. c:macro:: CAHUTE_FILE_TYPE_CASIOLINK

    CASIOLINK archive, that can be used as a main memory archive;
    see :ref:`file-format-topic-casiolink` for more information.

.. c:macro:: CAHUTE_FILE_TYPE_EACT_FX

    fx e-Activity; see :ref:`file-format-topic-g1e` for more information.

.. c:macro:: CAHUTE_FILE_TYPE_FKEY_FX

    fx function keys file; see :ref:`file-format-topic-g1n` for more information.

.. c:macro:: CAHUTE_FILE_TYPE_FKEY_CG

    fx-CG function keys file; see :ref:`file-format-topic-g3n`
    for more information.

.. c:macro:: CAHUTE_FILE_TYPE_LANG_CG

    fx-CG language file; see :ref:`file-format-topic-g3l` for more information.

.. c:macro:: CAHUTE_FILE_TYPE_LANG_FX

    fx language file; see :ref:`file-format-topic-g1l` for more information.

.. c:macro:: CAHUTE_FILE_TYPE_MAINMEM

    fx main memory archive; see :ref:`file-format-topic-mainmem` for more
    information.

.. c:macro:: CAHUTE_FILE_TYPE_PICTURE_CG

    fx-CG picture; see :ref:`file-format-topic-g3p` for more information.

.. c:macro:: CAHUTE_FILE_TYPE_PICTURE_CP

    fx-CP picture; see :ref:`file-format-topic-c2p` for more information.
