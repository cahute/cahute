...
.. c:function:: int cahute_open_serial_link(cahute_context *context, \
    ...
    * On AmigaOS, it will be the serial unit number with the case-insensitive
    ...
    .. note::
        ...
        :ref:`protocol-topic-seven-command-02` was issued to change the serial link
    ...
    .. c:macro:: CAHUTE_SERIAL_NODISC
        ...
        **not** provided, device discovery is not run once
        ...
        It is only effective when :ref:`protocol-topic-seven` or
        :ref:`protocol-topic-cas300` is used.
...
.. _header-ref-cahute-link-transport:
...
.. c:function:: int cahute_send_file_to_storage(cahute_link *link, \
    ...
    * If the function returns any other value, the overwrite is confirmed,
    ...
    See :ref:`protocol-topic-seven-send-file-to-storage` for the use case
    with Protocol 7.00.
...
.. c:function:: int cahute_request_file_from_storage(cahute_link *link, \
    ...
    See :ref:`protocol-topic-seven-request-file-from-storage` for the use case
    with Protocol 7.00.
...
.. c:function:: int cahute_copy_file_on_storage(cahute_link *link, \
    ...
    See :ref:`protocol-topic-seven-copy-file-on-storage` for the use case with
    Protocol 7.00.
...
.. c:function:: int cahute_delete_file_from_storage(cahute_link *link, \
    ...
    See :ref:`protocol-topic-seven-delete-file-on-storage` for the use case
    with Protocol 7.00.
...
.. c:function:: int cahute_list_storage_entries(cahute_link *link, \
    ...
    See :ref:`protocol-topic-seven-list-files-on-storage` for the use case with
    Protocol 7.00.
...
.. c:function:: int cahute_reset_storage(cahute_link *link, \
    ...
    See :ref:`protocol-topic-seven-reset-storage` for the use case with
    Protocol 7.00.
...
.. c:function:: int cahute_optimize_storage(cahute_link *link, \
    ...
    See :ref:`protocol-topic-seven-optimize-storage` for the use case with
    Protocol 7.00.
...
.. c:function:: int cahute_backup_rom(cahute_link *link, \
    ...
    See :ref:`protocol-topic-seven-backup-rom` for the use case with
    Protocol 7.00.
...
.. c:function:: int cahute_upload_and_run_program(cahute_link *link, \
    ...
    See :ref:`protocol-topic-seven-upload-and-run` for the use case with
    Protocol 7.00.
