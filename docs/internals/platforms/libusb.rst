...
pointer; see :ref:`internals-context-pointers` for more information.
...
browses it. If an entry matches one of the entries in :ref:`usb-detection`,
then it is yielded.
...
.. note::
    ...
    On :ref:`system-windows`, the port number is considered to be a device
    address; see :ref:`internals-win32-device-address` for more information.
