...
in :ref:`build-guide`. It is recommended to use the tarballs rather than
...
* Build and run the guides you have the hardware and system support for,
  e.g. :ref:`developer-guide-detect-usb`. See :ref:`developer-guide-build`
...
As described in :ref:`project-topic-release-process`, when a new release is
created, a new entry is created on the Releases_ page of the Gitlab repository.
