...
As described in :ref:`project-topic-feedback`, the project does not collect
statistics regarding its usage, therefore you are invited to:

* Report the issues you encounter, see :ref:`contribution-guide-report-issue`
  to discover how;
* Provide feedback and suggest features you are lacking in either the
  ...
  listed in :ref:`project-topic-forums`.
...
:ref:`contribution-guide-report-issue` guide!
...
can be the object of issues produced in :ref:`contribution-guide-report-issue`.
...
:ref:`install-guide`, you can probably help packaging Cahute for it and
contributing to your distribution in order to make the package official!

You can find generic packaging instructions in
:ref:`contribution-guide-packaging`, to provide you with elements that will
help you get the gist of Cahute packaging.
...
See :ref:`contribution-guide-create-merge-request` for more information.

.. _Github repository: https://github.com/cahute/cahute
.. _Gitlab repository: https://gitlab.com/cahute/cahute
.. _Repository issues: https://gitlab.com/cahute/cahute/-/issues
.. _Merge requests: https://gitlab.com/cahute/cahute/-/merge_requests
