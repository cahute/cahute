.. system-guides::
    ...
    * - |system-arch|
      ...
      - * :ref:`From the AUR <install-guide-linux-aur>`
        * :ref:`From the AUR (MinGW-w64)
          <install-guide-linux-aur-mingw>`
        * :ref:`Using GiteaPC <install-guide-linux-giteapc>`
        * :ref:`Using GiteaPC (gint)
          <install-guide-linux-giteapc-gint>`
      - * :ref:`Natively <build-guide-linux-sh>`
    * - |system-apple|
      - :ref:`feature-topic-system-macos`
      - * :ref:`Using Homebrew <install-guide-macos-homebrew>`
      - * :ref:`Natively <build-guide-macos-sh>`

.. note::

    Support and distribution of other systems is in progress or is awaiting
    volunteers:
    ...
    .. system-guides::
        ...
        * - |system-win|
          ...
          - * :ref:`For Vista+ using Visual Studio
              <build-guide-windows-vs>`
            * :ref:`For XP using Visual Studio <build-guide-windows-vs-xp>`
            * :ref:`For XP+ using Visual Studio and MinGW-w64
              <build-guide-windows-vs-mingw>`
            * :ref:`Using MinGW-w64 from Archlinux
              <build-guide-windows-mingw>`
            * :ref:`For Win 1.x+ using OpenWatcom from Archlinux
              <build-guide-windows-ow-win16>`
        * - |system-debian|
          - :ref:`feature-topic-system-debian`
          - * :ref:`Using APT <install-guide-linux-deb>`
            * :ref:`Using GiteaPC <install-guide-linux-giteapc>`
            * :ref:`Using GiteaPC (gint)
              <install-guide-linux-giteapc-gint>`
          - * :ref:`Natively <build-guide-linux-sh>`
        * - |system-redhat|
          - :ref:`feature-topic-system-redhat`
          - * :ref:`Using RPM <install-guide-linux-redhat>`
            * :ref:`Using GiteaPC <install-guide-linux-giteapc>`
            * :ref:`Using GiteaPC (gint)
              <install-guide-linux-giteapc-gint>`
          - * :ref:`Natively <build-guide-linux-sh>`
        * - |system-voidlinux|
          ...
          - * :ref:`Using XBPS <install-guide-linux-void>`
            * :ref:`Using GiteaPC <install-guide-linux-giteapc>`
            * :ref:`Using GiteaPC (gint)
              <install-guide-linux-giteapc-gint>`
          - * :ref:`Natively <build-guide-linux-sh>`
        * - |system-amigaos|
          ...
          - * :ref:`From Aminet <install-guide-amigaos-aminet>`
          - * :ref:`From Linux <build-guide-amigaos-linux>`
        * - |system-freebsd|
...
.. |system-redhat| image:: /guides/install/redhat.svg
