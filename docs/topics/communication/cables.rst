...
.. list-table::
    ...
    * - USB Type-A
      ...
      - :ref:`USB Type-A to Mini-B <protocol-topic-cable-usb-mini-b>`
      - :ref:`USB Type-A to Type-C <protocol-topic-cable-usb-type-c>`
    * - 3-pin
...
.. _protocol-topic-cable-usb-mini-b:
...
.. _protocol-topic-cable-usb-type-c:
