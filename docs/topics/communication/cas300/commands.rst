.. _protocol-topic-cas300-commands:

CAS300 commands
===============

With CAS300, used by Classpad 300 / 330 (+) models, the
:ref:`protocol-topic-cas300-packet-01` inner payload (*P* field) is expected
to be at least 4 bytes long, and starts with the following:
...
.. _protocol-topic-cas300-command-0000:
...
.. _protocol-topic-cas300-command-0001:
...
.. _protocol-topic-cas300-command-0002:

``0002`` "Send device information"
----------------------------------

Sent by the device when requested using
:ref:`protocol-topic-cas300-command-0011`.
...
.. _protocol-topic-cas300-command-0003:
...
.. todo::
    ...
    :ref:`protocol-topic-seven-ascii-hex` value, and sometimes a 1-byte value
    directly.
...
.. _protocol-topic-cas300-command-000C:
...
.. _protocol-topic-cas300-command-000D:
...
.. _protocol-topic-cas300-command-000E:
...
.. _protocol-topic-cas300-command-000F:

``000F`` "Transfer file list"
-----------------------------

Followed by :ref:`protocol-topic-cas300-command-0000`, then data packets containing the
listing.
...
.. _protocol-topic-cas300-command-0010:
...
.. _protocol-topic-cas300-command-0011:

``0011`` "Request device information"
-------------------------------------

No payload. Answered by a :ref:`protocol-topic-cas300-command-0002`.
