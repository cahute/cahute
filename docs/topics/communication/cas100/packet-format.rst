.. _protocol-topic-cas100-packet-format:
...
.. _protocol-topic-cas100-packet-06:
...
See :ref:`protocol-topic-cas100-send` for more information.

.. _protocol-topic-cas100-packet-13:

``0x13`` -- Established packet
------------------------------

This packet is sent by the receiver to the sender on initiation, in response
to a :ref:`protocol-topic-cas100-packet-16`.
It is a single-byte packet, i.e. it has no payload.

See :ref:`protocol-topic-cas100-init` for more information.

.. _protocol-topic-cas100-packet-16:
...
.. _protocol-topic-cas100-packet-3A:
...
See :ref:`protocol-topic-cas100-data-types` for more information.
