...
.. note::
    ...
    See :ref:`protocol-topic-seven-report-invalid-checksum` for more
    information.
...
.. note::
    ...
    See :ref:`protocol-topic-seven-check-link` for more information.

.. _protocol-topic-seven-report-invalid-checksum:
...
.. _protocol-topic-seven-init-link:
...
:ref:`protocol-topic-seven-packet-05` for more information.

.. _protocol-topic-seven-terminate-link:
...
See :ref:`protocol-topic-seven-packet-18` for more information on the
terminate packet.

.. _protocol-topic-seven-check-link:
...
:ref:`protocol-topic-seven-packet-02` for more information.

If this flow is not run and the connection is active for more than 6 minutes,
the passive side terminates the connection.

.. _protocol-topic-seven-confirm-overwrite:

Confirming or rejecting overwrite
---------------------------------

Some commands, such as :ref:`protocol-topic-seven-command-45`, may require
overwrite confirmation in case the file already exists on the calculator.
In such cases, the flow is the following:
...
* The overwrite confirmation request is represented as a NAK packet with
  the ``02`` subtype; see :ref:`protocol-topic-seven-packet-15`.
* The overwrite confirmation is represented as an ACK packet with the
  ``01`` subtype; see :ref:`protocol-topic-seven-packet-06`.
* The overwrite denial is represented as a NAK packet with the ``03``
  subtype; see :ref:`protocol-topic-seven-packet-15`.
* Both the overwrite confirmation acknowledgement and overwrite denial
  ...
  see :ref:`protocol-topic-seven-packet-06`.

.. _protocol-topic-seven-transmit-data:
...
Data packets are described in :ref:`protocol-topic-seven-packet-02`.
...
.. _protocol-topic-seven-packet-shifting:
...
.. _protocol-topic-seven-request-transfer:
...
such a case is :ref:`protocol-topic-seven-command-24`, and the transfer command
emitted by the calculator after the roleswap is
:ref:`protocol-topic-seven-command-25`.

.. note::

    The transfer request can lead to multiple commands from the calculator,
    e.g. with commands such as :ref:`protocol-topic-seven-command-29` that will
    spawn one command and associated data transmission by file in the
    main memory.

.. _protocol-topic-seven-get-device-information:
...
.. note::
    ...
    in :ref:`protocol-topic-seven-request-transfer`, or because the
    aforementioned flow did not exist when this command was conceived.

.. _protocol-topic-seven-update-serial-params:
...
:ref:`protocol-topic-seven-command-02`, using the following flow:
