...
.. _protocol-topic-seven-fxremote-command-70:
...
* :ref:`protocol-topic-seven-fxremote-flash`.

.. _protocol-topic-seven-fxremote-command-71:
...
.. _protocol-topic-seven-fxremote-command-72:
...
.. _protocol-topic-seven-fxremote-command-76:
...
* An acknowledgement packet, of basic subtype (see
  :ref:`protocol-topic-seven-packet-06`);
* A data packet, containing the provided data (see
  :ref:`protocol-topic-seven-packet-02`).
...
.. _protocol-topic-seven-fxremote-command-78:
