.. _protocol-topic-cas40-data-types:
...
.. _protocol-topic-cas40-header-al-end:
...
see :ref:`protocol-topic-cas40-al-mode` for more information.

This is not followed by any data parts.

.. _protocol-topic-cas40-header-end:
...
.. note::
    ...
    enabled; see :ref:`protocol-topic-cas40-al-mode`.

.. _protocol-topic-cas40-header-a1:
...
.. _protocol-topic-cas40-header-aa:

``AA`` Dynamic Graph in Bulk
----------------------------

This file type is actually the same as :ref:`protocol-topic-cas40-header-a1`,
except it is in a context where multiple editor programs are being sent, i.e.
the data type is non-final.

.. _protocol-topic-cas40-header-ad:
...
.. list-table::
    ...
    * - 2 (0x02)
      ...
      - Value (real part)
      -
      - :ref:`format-topic-number-casiolink-bcd`
    * - 12 (0x0C)
      - 10 B
...
.. _protocol-topic-cas40-header-al:
...
.. note::
    ...
    required; see :ref:`protocol-topic-cas40-al-mode` for more information.

.. _protocol-topic-cas40-header-am:

``AM`` Variable Memories
------------------------

This is equivalent to :ref:`protocol-topic-cas40-header-ad`, but only returns
variables designated using a letter or symbol.

.. _protocol-topic-cas40-header-bu:
...
.. _protocol-topic-cas40-header-dc:
      ...
      - Screenshot format, among the following:
        ...
        .. list-table::
            ...
            * - Value
              - Description
            * - ``\x11``
              - :ref:`format-topic-picture-1bit-multiple-cas50`
    * - 3 (0x03)
      - 1 B
      - Direction (*DR*)
      -
...
.. _protocol-topic-cas40-header-dd:
      ...
      - Screenshot format, among the following:
        ...
        .. list-table::
            ...
            * - Value
              - Description
            * - ``\x10``
              - :ref:`format-topic-picture-1bit-cas50`.
    * - 3 (0x03)
      - 1 B
      - Direction (*DR*)
      -
...
.. _protocol-topic-cas40-header-dm:
...
.. _protocol-topic-cas40-header-en:
...
.. _protocol-topic-cas40-header-ep:
...
.. _protocol-topic-cas40-header-f1:
...
.. _protocol-topic-cas40-header-f6:
...
.. _protocol-topic-cas40-header-fn:

``FN`` Single Editor Program in Bulk
------------------------------------

This file type is actually the same as :ref:`protocol-topic-cas40-header-en`,
except it is in a context where multiple editor programs are being sent, i.e.
the data is non-final.

.. _protocol-topic-cas40-header-fp:

``FP`` Single Password Protected Editor Program in Bulk
-------------------------------------------------------

This file type is actually the same as :ref:`protocol-topic-cas40-header-ep`,
except it is in a context where multiple editor programs are being sent, i.e.
the data is non-final.

.. _protocol-topic-cas40-header-g1:
...
.. _protocol-topic-cas40-header-ga:

``GA`` Graph Function in Bulk
-----------------------------

This file type is actually the same as :ref:`protocol-topic-cas40-header-g1`,
except it is in a context where multiple graph functions are being sent, i.e.
the data is non-final.

.. _protocol-topic-cas40-header-gf:
...
.. _protocol-topic-cas40-header-gr:
...
.. _protocol-topic-cas40-header-gt:
...
.. _protocol-topic-cas40-header-m1:
...
.. _protocol-topic-cas40-header-pd:
...
.. _protocol-topic-cas40-header-pz:
...
See :ref:`protocol-topic-cas40-header-p1` for more information.

This data type is final.

.. _protocol-topic-cas40-header-rt:
...
.. _protocol-topic-cas40-header-sd:
...
.. _protocol-topic-cas40-header-sr:
...
.. _protocol-topic-cas40-header-ss:
