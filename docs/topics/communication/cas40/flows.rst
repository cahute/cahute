...
See :ref:`protocol-topic-cas40-packet-format` for more information.

.. _protocol-topic-cas40-send:
...
:ref:`protocol-topic-cas40-header-end` data type.

.. _protocol-topic-cas40-al-mode:
...
This includes :ref:`protocol-topic-cas40-header-end`, which does not end the
communication anymore, as once this mode is enabled, only
:ref:`protocol-topic-cas40-header-al-end` is able to do this.

See the following for more information:

* :ref:`protocol-topic-cas40-header-al`
* :ref:`protocol-topic-cas40-header-al-end`
