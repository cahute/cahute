...
See :ref:`protocol-topic-cas50-packet-format` for more information.

.. _protocol-topic-cas50-send:
...
:ref:`protocol-topic-cas50-header-end` data type.

.. _protocol-topic-cas50-request:
