.. _protocol-topic-cas50-packet-format:
...
.. _protocol-topic-cas50-packet-13:

``0x13`` -- Established packet
------------------------------

This packet is sent by the receiver to the sender on initiation, in response
to a :ref:`protocol-topic-cas50-packet-16`.
It is a single-byte packet, i.e. it has no payload.

See :ref:`protocol-topic-cas50-init` for more information.

.. _protocol-topic-cas50-packet-15:
...
.. _protocol-topic-cas50-packet-16:
...
.. _protocol-topic-cas50-packet-21:
...
.. _protocol-topic-cas50-packet-24:
...
.. _protocol-topic-cas50-packet-2B:
