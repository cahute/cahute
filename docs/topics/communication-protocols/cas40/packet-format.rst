.. _protocol-topic-cas40-packet-format:
...
.. _protocol-topic-cas40-packet-06:
...
See :ref:`protocol-topic-cas40-send` for more information.

.. _protocol-topic-cas40-packet-13:

``0x13`` -- Established packet
------------------------------

This packet is sent by the receiver to the sender on initiation, in response
to a :ref:`protocol-topic-cas40-packet-16`.
It is a single-byte packet, i.e. it has no payload.

See :ref:`protocol-topic-cas40-init` for more information.

.. _protocol-topic-cas40-packet-16:
