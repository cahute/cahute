...
.. note::
    ...
    from that time (see :ref:`cli-ref-cas`), and 40, the size in bytes of
    the headers used in the protocol.

This protocol is usually present over :ref:`protocol-topic-transport-serial`.
