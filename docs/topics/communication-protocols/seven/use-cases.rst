...
.. _protocol-topic-seven-send-file-to-storage:
...
* Command :ref:`protocol-topic-seven-command-45`;
* :ref:`protocol-topic-seven-confirm-overwrite`;
* :ref:`protocol-topic-seven-transmit-data`.

This flow is used by ``p7 send``; see the :ref:`cli-ref-p7-send`
for more information.

.. _protocol-topic-seven-request-file-from-storage:
...
* Command :ref:`protocol-topic-seven-command-44`;
* Command :ref:`protocol-topic-seven-command-45`;
* :ref:`protocol-topic-seven-request-transfer`;
* :ref:`protocol-topic-seven-transmit-data`.

This flow is used by ``p7 get``; see the :ref:`cli-ref-p7-get`
for more information.

.. _protocol-topic-seven-copy-file-on-storage:
...
* Command :ref:`protocol-topic-seven-command-48`.

This flow is used by ``p7 copy``; see the :ref:`cli-ref-p7-copy`
for more information.

.. _protocol-topic-seven-delete-file-on-storage:
...
* Command :ref:`protocol-topic-seven-command-46`.

This flow is used by ``p7 delete``; see the :ref:`cli-ref-p7-delete`
for more information.

.. _protocol-topic-seven-list-files-on-storage:
...
* Command :ref:`protocol-topic-seven-command-4D`;
* Command :ref:`protocol-topic-seven-command-4E`;
* :ref:`protocol-topic-seven-request-transfer`.

This flow is used by ``p7 list``; see the :ref:`cli-ref-p7-list`
for more information.

.. _protocol-topic-seven-reset-storage:
...
* Command :ref:`protocol-topic-seven-command-4A`.

This flow is used by ``p7 reset``; see the :ref:`cli-ref-p7-reset`
for more information.

.. _protocol-topic-seven-optimize-storage:
...
* Command :ref:`protocol-topic-seven-command-51`.

This flow is used by ``p7 optimize``; see the :ref:`cli-ref-p7-optimize`
for more information.

.. _protocol-topic-seven-backup-rom:
...
see :ref:`protocol-topic-seven-devices` for more information.

For more information, consult the following sections:

* Command :ref:`protocol-topic-seven-command-4F`;
* Command :ref:`protocol-topic-seven-command-50`;
* :ref:`protocol-topic-seven-request-transfer`.

This flow is used by ``p7os get``; see the :ref:`cli-ref-p7os-get` for more
information.

.. _protocol-topic-seven-upload-and-run:
...
* Command :ref:`protocol-topic-seven-command-56`;
* :ref:`protocol-topic-seven-transmit-data`.

.. _protocol-topic-seven-fxremote-flash:
...
* :ref:`protocol-topic-seven-fxremote-command-70`
* :ref:`protocol-topic-seven-fxremote-command-71`
* :ref:`protocol-topic-seven-fxremote-command-72`
* :ref:`protocol-topic-seven-fxremote-command-76`
* :ref:`protocol-topic-seven-fxremote-command-78`
