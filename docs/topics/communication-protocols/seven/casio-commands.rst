.. _protocol-topic-seven-casio-commands:
...
.. _protocol-topic-seven-command-00:
...
.. _protocol-topic-seven-command-01:
...
.. seven-command::
    ...
    See :ref:`protocol-topic-seven-get-device-information` for the related
    flow, and :ref:`protocol-topic-seven-packet-06` for more information
    regarding the payload format.

.. _protocol-topic-seven-command-02:
...
.. seven-command::
    ...
    See :ref:`protocol-topic-seven-update-serial-params` for more information.

.. _protocol-topic-seven-command-06:
...
.. seven-command::
    :code: 06
    :d1: 4-char :ref:`protocol-topic-seven-ascii-hex` number of minutes
    :d1-example: 0001
...
.. _protocol-topic-seven-command-07:
...
.. _protocol-topic-seven-command-08:
...
.. _protocol-topic-seven-command-09:
...
.. _protocol-topic-seven-command-0A:
...
.. _protocol-topic-seven-command-20:
...
.. _protocol-topic-seven-command-21:
...
.. _protocol-topic-seven-command-22:
...
.. _protocol-topic-seven-command-23:
...
.. _protocol-topic-seven-command-24:
...
.. seven-command::
    ...
    :ref:`protocol-topic-seven-command-25`.

.. _protocol-topic-seven-command-25:
...
.. _protocol-topic-seven-command-26:
...
.. _protocol-topic-seven-command-27:
...
.. _protocol-topic-seven-command-28:
...
.. _protocol-topic-seven-command-29:
...
.. _protocol-topic-seven-command-2A:
...
.. _protocol-topic-seven-command-2B:
...
.. seven-command::
    ...
    using command :ref:`protocol-topic-seven-command-2C`.

.. _protocol-topic-seven-command-2C:
...
.. _protocol-topic-seven-command-2D:
...
.. seven-command::
    ...
    command :ref:`protocol-topic-seven-command-2E`.

.. _protocol-topic-seven-command-2E:
...
.. _protocol-topic-seven-command-2F:
...
.. seven-command::
    ...
    :ref:`protocol-topic-seven-command-30`.

.. _protocol-topic-seven-command-30:
...
.. _protocol-topic-seven-command-31:
...
.. seven-command::
    ...
    Request a setup entry, to be sent using command
    :ref:`protocol-topic-seven-command-32`.

.. _protocol-topic-seven-command-32:
...
.. _protocol-topic-seven-command-33:
...
.. _protocol-topic-seven-command-40:
...
.. _protocol-topic-seven-command-41:
...
.. _protocol-topic-seven-command-42:
...
.. _protocol-topic-seven-command-43:
...
.. _protocol-topic-seven-command-44:
...
.. seven-command::
    ...
    * :ref:`protocol-topic-seven-request-file-from-storage`.

.. _protocol-topic-seven-command-45:
...
.. seven-command::
    ...
    * :ref:`protocol-topic-seven-send-file-to-storage`;
    * :ref:`protocol-topic-seven-request-file-from-storage`.

.. _protocol-topic-seven-command-46:
...
.. seven-command::
    ...
    * :ref:`protocol-topic-seven-delete-file-on-storage`.

.. _protocol-topic-seven-command-47:
...
.. _protocol-topic-seven-command-48:
...
.. seven-command::
    ...
    * :ref:`protocol-topic-seven-copy-file-on-storage`.

.. _protocol-topic-seven-command-49:
...
.. seven-command::
    ...
    :ref:`protocol-topic-seven-command-45`.

.. _protocol-topic-seven-command-4A:
...
.. seven-command::
    ...
    * :ref:`protocol-topic-seven-reset-storage`.

.. _protocol-topic-seven-command-4B:
...
.. _protocol-topic-seven-command-4C:
...
.. _protocol-topic-seven-command-4D:
...
.. seven-command::
    ...
    * :ref:`protocol-topic-seven-list-files-on-storage`.

.. _protocol-topic-seven-command-4E:
...
.. _protocol-topic-seven-command-4F:
...
.. _protocol-topic-seven-command-50:
...
.. _protocol-topic-seven-command-51:
...
.. seven-command::
    ...
    * :ref:`protocol-topic-seven-optimize-storage`.

.. _protocol-topic-seven-command-52:
...
.. seven-command::
    ...
    :ref:`protocol-topic-seven-command-53`.

.. _protocol-topic-seven-command-53:
...
.. _protocol-topic-seven-command-54:
...
.. seven-command::
    ...
    :ref:`protocol-topic-seven-command-55`.

.. _protocol-topic-seven-command-55:
...
.. _protocol-topic-seven-command-56:
...
.. list-table::
    ...
    * - 0 (0x00)
      ...
      - 8-char :ref:`protocol-topic-seven-ascii-hex` number.
    * - 8 (0x08)
      - 8 B
      - Load address
      - RAM address at which to load the provided payload.
      - 8-char :ref:`protocol-topic-seven-ascii-hex` number, usually set to
        ``88030000``.
    * - 16 (0x10)
      - 8 B
      - Start address
...
* :ref:`protocol-topic-seven-upload-and-run`.

.. _protocol-topic-seven-command-59:
...
.. _protocol-topic-seven-command-5A:
