...
as :ref:`one of the CAHUTE_FILE_TYPE_* macros
<header-ref-cahute-file-type-macros>`.

Main memory data reading
~~~~~~~~~~~~~~~~~~~~~~~~

One can use :c:func:`cahute_get_data_from_file` to extract main memory data
from the file, as described in :ref:`feature-topic-data`.
